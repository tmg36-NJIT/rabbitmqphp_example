...
sudo ufw allow from 192.168.192.0/24 to any port 9993 comment "Allow ZeroTier Internally"
sudo ufw allow from 192.168.192.0/24 to any port 22 comment "Allow SSH Internally"
...
sudo ufw allow from 192.168.192.0/24 to any port 25672 comment "Allow RabbitMQ Cluster Internally"
sudo ufw allow from 192.168.192.0/24 to any port 4369 comment "Allow Erlang Node Discovery Internally"
sudo ufw allow from 192.168.192.0/24 to any port 19999 comment "Allow Netdata Dashboard Internally"
sudo ufw allow from 192.168.192.0/24 to any port 8125 comment "Allow Netdata/statsd Internally"
sudo ufw allow from 192.168.192.0/24 to any port 8125 comment "Allow Netdata/statsd Internally"
sudo ufw allow from 192.168.192.0/24 to any port 3306 comment "Allow MySQL Server Internally"
sudo ufw allow from 192.168.192.0/24 to any port 33060 comment "Allow MySQL Plugin Internally"
sudo ufw allow from 192.168.192.0/24 to any port 5353 comment "Allow mDNS/Avahi Internally"
